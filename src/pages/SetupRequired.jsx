...
export default function SetupRequired() {
  return <div className="grid min-h-screen place-items-center bg-gradient-to-br from-primary-50 to-white p-4">
    <div className="card w-full max-w-2xl space-y-4">
      ...
      <p className="text-slate-600">To use SGMI-KK LENDMART you need to connect a Firebase project. The app expects environment variables for Auth and Firestore.</p>
      <ol className="list-decimal space-y-2 pl-5 text-sm text-slate-700">
        ...
        <li>Create a <code className="rounded bg-slate-100 px-1">.env</code> file in the project root with:</li>
      </ol>
